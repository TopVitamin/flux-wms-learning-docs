...
参考：[原章节](../01-按章节拆分的md文件/03-FLUX-WMS概述.md)

## 0. 资料联动

| 资料层 | 入口 |
| --- | --- |
| 手册事实 | [01/03 FLUX WMS 概述](../01-按章节拆分的md文件/03-FLUX-WMS概述.md) |
| 流程图 | [02/03 FLUX WMS 概述](../02-按章节拆分的流程图/03-FLUX-WMS概述.md) |
...
> [手册事实] 手册把 FLUX WMS 描述为实时 WMS，并列出业务系统、配置、基础设置、入库、库存、出库、任务、费收、日志、报表和扩展等模块。
>
...
手册将 FLUX WMS 描述为实时 WMS，支持 B/S 架构、云部署、多种数据库和与 ERP、供应链计划、销售预测、订单及其他执行系统的通信。系统功能拆分为业务系统管理、业务系统配置、基础设置、仓库设置、业务规则、入库、库存、出库、任务、费收、日志、报表、二次开发、自动打印等模块，并可扩展 RF、标签、Cross Dock、归档等模块。
